...
public class Practice12MeasureTextView extends View {
...

    {
        ...
        measureText = paint1.measureText(text1);
        measureText1 = paint2.measureText(text2);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text2, 50 + measureText, 200, paint2);

        canvas.drawText(text3, 50 + measureText+ measureText1, 200, paint1);
    }
}
